  ...
  return (
    ...
    >
      <img
        ...
        // alt="Me"
        // className="h-6 w-6 md:h-7 md:w-7 opacity-60 group-hover:opacity-100 transition-opacity object-contain rounded-full"
        className='w-[7vh] h-[7vh] cursor-pointer rounded-[50%] '
    ...
    {showProfile && <div className='absolute bg-white top-[130%] right-[10%] w-[18vw] h-fit p-4 text-[0.9vw] rounded-lg shadow-lg '> 
      <div className='h-[72%]  flex flex-col mb-2'>
        <div className='h-fit flex flex-row cursor-pointer'>
          ...
          <img src={userData.user?.profileImage || "profile.png"}  alt="" className='w-[8vh] h-[8vh] rounded-[50%] '/>
